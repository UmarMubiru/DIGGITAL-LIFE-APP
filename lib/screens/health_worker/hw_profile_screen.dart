                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      ...
                      await userProv.updatePhoto(
                        File(picked.path),
                      );
                    },
                    child: CircleAvatar(
                      radius: 36,
                      backgroundColor: (user.hasPhotoUrl && user.photoUrl.isNotEmpty) || user.hasPhoto
                          ? null 
                          : user.hashColor(),
                      backgroundImage: user.hasPhoto
                          ? FileImage(File(user.photoPath))
                          : (user.hasPhotoUrl && user.photoUrl.isNotEmpty)
                              ? NetworkImage(user.photoUrl) as ImageProvider
                              : null,
                      child: (user.hasPhoto || (user.hasPhotoUrl && user.photoUrl.isNotEmpty))
                          ? null
                          : Text(
                              user.initials(),
                              style: TextStyle(
